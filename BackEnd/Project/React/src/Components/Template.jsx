                                ...
                                <div className="col-md-12">
                                    <div className="card border-0 mb-4 no-bg">
                                        <div className="card-header py-3 px-0 d-flex align-items-center justify-content-between border-bottom">
                                            <h3 className=" fw-bold flex-fill">Color Theme Settings</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="card col-lg-4">
                                    <div className="theme-buttons-container">
                                        <span
                                            ...
                                            data-color="#9AD2E9"
                                            style={{ backgroundColor: "#9AD2E9" }}
                                        />
                                        <span
                                            className="theme-buttons"
                                            data-color="#0CDA98"
                                            style={{ backgroundColor: "#0CDA98" }}
                                        />
                                        <span
                                            className="theme-buttons"
                                            data-color="#EFB823"
                                            style={{ backgroundColor: "#EFB823" }}
                                        />
                                        <span
                                            className="theme-buttons"
                                            data-color="#C78DE3"
                                            style={{ backgroundColor: "#C78DE3" }}
                                        />
                                        <span
                                            className="theme-buttons"
                                            data-color="#E0EFFF"
...
export default TemplateSuperAdmin;
