                    ...
                    <div className="d-flex flex-column h-100">
                        ...
                        {UserRole == "SuperAdmin" ?
                            ...
                            <ul className="menu-list flex-grow-1 mt-3">
                                ...
                                <li>
                                    <a className="m-link active" href="/360view">
                                        <i className="icofont-star-e-Learn" /> <span>360 View</span>
                                    </a>
                                </li>
                                ...
                                <img class="avatar rounded-circle" src="assets/images/xs/avatar8.jpg" alt=""> */}
                                    ...
                                    <div className="dropdown user-profile ml-2 ml-sm-3 d-flex align-items-center zindex-popover">
                                        ...
                                        <a className="nav-link dropdown-toggle pulse p-0" href="#" role="button" data-bs-toggle="dropdown" data-bs-display="static" >
                                            <img className="avatar lg rounded-circle img-thumbnail" src="assets/images/profile-teacher.jpg" alt="profile" />
                                        </a>
                                        <div className="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-end p-0 m-0">
                                            <div className="card border-0 w280">
                                                <div className="card-body pb-0">
                                                    <div className="d-flex py-1">
                                                        <img className="avatar rounded-circle" src="assets/images/profile-teacher.jpg" alt="profile" />
                                ...
                                <div className="col-lg-8 col-md-12 flex-column">
                                    <div className="card mb-3 color-bg-200">
                                        <div className="card-header py-3">
                                            <h4 className="mb-0 fw-bold">Audits conducted</h4>
                                            {/* <span>How much space has your team used?</span> */}
                                        </div>
                                        <div
                                        ...
                                        >
                                            <div
                                                className="btn-group btn-postion"
                                                role="group"
                                    ...
                                    <div className="card mb-3 color-bg-200">
                                        <div className="card-body">
                                            <div className="licences_used">
                                                <h6 className="mb-3 fw-bold ">Licences used for Members</h6>
                                                ...
                                                <div className="card mb-4 shadow-sm overflow-hidden border-0">
                                                    <div className="card-body overflow-hidden pb-0">
                                                        <div className="d-flex align-items-center">
                                                            <div className="avatar lg rounded-1 no-thumbnail bg-primary text-white">
                                                                <i className="bi bi-person-check-fill fs-4" />
                                                            </div>
                                                            ...
                                                            <button
                                                                ...
                                                                title="The percentage of memebrs in your team out of the Active members"
                                                            >
                                                ...
                                                <div className="card shadow-sm overflow-hidden border-0">
                                                    <div className="card-body overflow-hidden pb-0">
                                                        <div className="d-flex align-items-center">
                                                            ...
                                                            <div className="flex-fill ms-3 text-truncate">
                                                                <div className="">Invitations pending</div>
                                                            ...
                                                            <button
                                                                ...
                                                                data-bs-toggle="tooltip"
                                                                data-bs-placement="left"
                                                                title="The percentage of memebrs in your team out of the Licences you purchased"
                                                            >
                                                                <i className="bi bi-info-circle-fill " />
                                                            </button>
                                                        </div>
...
export default SuperAdmin360view;
